...
**Rung 2 — ceiling $18.45, floor $16.70.**

Rung 1 cleared 2026-09-03: $17.98 subtotal was fully covered, $0.00 out of pocket, $0.76 of stipend left unused. Advance to rung 3 after the next fully-covered order.

## Rotation state

Read this before building a slate.

- **Last format:** `salad` (2026-09-03) — do not recommend `salad` as the top pick next order.
- **Last `carb-base`:** never — available, but it is a once-every-three-orders slot, not a default.
- **Formats in the last four orders:** `salad` x1. Slate needs to open up.
- **Last restaurant:** Scali Deli & Cafe — prefer a different one if the menus allow.
